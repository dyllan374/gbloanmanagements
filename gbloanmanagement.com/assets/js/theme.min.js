function loancalculate() { var t = $("#pricipal").text(), e = $("#totalyear").text(), i = $("#intrest").text() / 100 / 12, s = Math.pow(1 + i, e), n = t * i * (s / (s - 1)), o = e * n, a = o - t, r = n.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), l = (t.toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), o.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ",")), h = a.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","); $("#emi").html(r), $("#tbl_emi").html(h), $("#tbl_la").html(l) } !function () { "use strict"; $('[data-bs-toggle="offcanvas"]').length && document.querySelector('[data-bs-toggle="offcanvas"]').addEventListener("click", (function () { document.querySelector(".offcanvas-collapse").classList.toggle("open") })), $(".counter").length && $(".counter").each((function () { var t = $(this), e = t.attr("data-count"); $({ countNum: t.text() }).animate({ countNum: e }, { duration: 1e4, easing: "linear", step: function () { t.text(Math.floor(this.countNum)) }, complete: function () { t.text(this.countNum) } }) })), $(".dropdown-menu a.dropdown-toggle").length && $(".dropdown-menu a.dropdown-toggle").on("click", (function (t) { return $(this).next().hasClass("show") || $(this).parents(".dropdown-menu").first().find(".show").removeClass("show"), $(this).next(".dropdown-menu").toggleClass("show"), $(this).parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown", (function (t) { $(".dropdown-submenu .show").removeClass("show") })), !1 })) }(), function () { if ($(".sliderFirst").length) tns({ container: ".sliderFirst", loop: !0, startIndex: 1, items: 1, nav: !1, autoplay: !0, swipeAngle: !1, speed: 400, autoplayButtonOutput: !1, mouseDrag: !0, lazyload: !0, gutter: 20, controlsContainer: "#sliderFirstControls" }); if ($(".sliderSecond").length) tns({ container: ".sliderSecond", loop: !0, startIndex: 1, items: 1, nav: !1, autoplay: !0, swipeAngle: !1, speed: 400, autoplayButtonOutput: !1, mouseDrag: !0, lazyload: !0, gutter: 20, controlsContainer: "#sliderSecondControls", responsive: { 768: { items: 2 }, 990: { items: 3 } } }) }(), function () { if ($(".steps-slider").length) { var t = document.getElementsByClassName("steps-slider")[0], e = [document.getElementsByClassName("input-with-keypress-0")[0]]; noUiSlider.create(t, { start: 60, animate: !1, range: { min: 50, max: 100 } }), t.noUiSlider.on("update", (function (t, i) { e[i].value = t[i] })), e.forEach((function (e, i) { e.addEventListener("change", (function () { t.noUiSlider.setHandle(i, this.value) })), e.addEventListener("keydown", (function (e) { var s, n = t.noUiSlider.get(), o = Number(n[i]), a = t.noUiSlider.steps()[i]; switch (e.which) { case 13: t.noUiSlider.setHandle(i, this.value); break; case 38: !1 === (s = a[1]) && (s = 1), null !== s && t.noUiSlider.setHandle(i, o + s); break; case 40: !1 === (s = a[0]) && (s = 1), null !== s && t.noUiSlider.setHandle(i, o - s) } })) })) } if ($(".amountSlider").length) { var i = document.getElementsByClassName("amountSlider")[0]; e = [document.getElementsByClassName("amountInput")[0]]; noUiSlider.create(i, { start: 3e3, animate: !1, range: { min: 1e3, max: 5e3 }, format: wNumb({ decimals: 0, thousand: ",", prefix: " $" }) }), i.noUiSlider.on("update", (function (t, i) { e[i].value = t[i] })), e.forEach((function (t, e) { t.addEventListener("change", (function () { i.noUiSlider.setHandle(e, this.value) })), t.addEventListener("keydown", (function (t) { var s, n = i.noUiSlider.get(), o = Number(n[e]), a = i.noUiSlider.steps()[e]; switch (t.which) { case 13: i.noUiSlider.setHandle(e, this.value); break; case 38: !1 === (s = a[1]) && (s = 1), null !== s && i.noUiSlider.setHandle(e, o + s); break; case 40: !1 === (s = a[0]) && (s = 1), null !== s && i.noUiSlider.setHandle(e, o - s) } })) })) } if ($(".amountSlider").length) { var s = document.getElementsByClassName("yearSlider")[0]; e = [document.getElementsByClassName("yearInput")[0]]; noUiSlider.create(s, { start: 2, animate: !1, range: { min: 1, max: 10 }, format: wNumb({ decimals: 0 }) }), s.noUiSlider.on("update", (function (t, i) { e[i].value = t[i] })), e.forEach((function (t, e) { t.addEventListener("change", (function () { s.noUiSlider.setHandle(e, this.value) })), t.addEventListener("keydown", (function (t) { var i, n = s.noUiSlider.get(), o = Number(n[e]), a = s.noUiSlider.steps()[e]; switch (t.which) { case 13: s.noUiSlider.setHandle(e, this.value); break; case 38: !1 === (i = a[1]) && (i = 1), null !== i && s.noUiSlider.setHandle(e, o + i); break; case 40: !1 === (i = a[0]) && (i = 1), null !== i && s.noUiSlider.setHandle(e, o - i) } })) })) } }(), $(".popup-youtube").magnificPopup({ disableOn: 700, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !1 }),
 ...
 */t.widget("ui.tooltip", { version: "1.12.1", options: { classes: { "ui-tooltip": "ui-corner-all ui-widget-shadow" }, content: function () { var e = t(this).attr("title") || ""; return t("<a>").text(e).html() }, hide: !0, items: "[title]:not([disabled])", position: { my: "left top+15", at: "left bottom", collision: "flipfit flip" }, show: !0, track: !1, close: null, open: null }, _addDescribedBy: function (e, i) { var s = (e.attr("aria-describedby") || "").split(/\s+/); s.push(i), e.data("ui-tooltip-id", i).attr("aria-describedby", t.trim(s.join(" "))) }, _removeDescribedBy: function (e) { var i = e.data("ui-tooltip-id"), s = (e.attr("aria-describedby") || "").split(/\s+/), n = t.inArray(i, s); -1 !== n && s.splice(n, 1), e.removeData("ui-tooltip-id"), (s = t.trim(s.join(" "))) ? e.attr("aria-describedby", s) : e.removeAttr("aria-describedby") }, _create: function () { this._on({ mouseover: "open", focusin: "open" }), this.tooltips = {}, this.parents = {}, this.liveRegion = t("<div>").attr({ role: "log", "aria-live": "assertive", "aria-relevant": "additions" }).appendTo(this.document[0].body), this._addClass(this.liveRegion, null, "ui-helper-hidden-accessible"), this.disabledTitles = t([]) }, _setOption: function (e, i) { var s = this; this._super(e, i), "content" === e && t.each(this.tooltips, (function (t, e) { s._updateContent(e.element) })) }, _setOptionDisabled: function (t) { this[t ? "_disable" : "_enable"]() }, _disable: function () { var e = this; t.each(this.tooltips, (function (i, s) { var n = t.Event("blur"); n.target = n.currentTarget = s.element[0], e.close(n, !0) })), this.disabledTitles = this.disabledTitles.add(this.element.find(this.options.items).addBack().filter((function () { var e = t(this); if (e.is("[title]")) return e.data("ui-tooltip-title", e.attr("title")).removeAttr("title") }))) }, _enable: function () { this.disabledTitles.each((function () { var e = t(this); e.data("ui-tooltip-title") && e.attr("title", e.data("ui-tooltip-title")) })), this.disabledTitles = t([]) }, open: function (e) { var i = this, s = t(e ? e.target : this.element).closest(this.options.items); s.length && !s.data("ui-tooltip-id") && (s.attr("title") && s.data("ui-tooltip-title", s.attr("title")), s.data("ui-tooltip-open", !0), e && "mouseover" === e.type && s.parents().each((function () { var e, s = t(this); s.data("ui-tooltip-open") && ((e = t.Event("blur")).target = e.currentTarget = this, i.close(e, !0)), s.attr("title") && (s.uniqueId(), i.parents[this.id] = { element: this, title: s.attr("title") }, s.attr("title", "")) })), this._registerCloseHandlers(e, s), this._updateContent(s, e)) }, _updateContent: function (t, e) { var i, s = this.options.content, n = this, o = e ? e.type : null; if ("string" == typeof s || s.nodeType || s.jquery) return this._open(e, t, s); (i = s.call(t[0], (function (i) { n._delay((function () { t.data("ui-tooltip-open") && (e && (e.type = o), this._open(e, t, i)) })) }))) && this._open(e, t, i) }, _open: function (e, i, s) { var n, o, a, r, l = t.extend({}, this.options.position); function h(t) { l.of = t, o.is(":hidden") || o.position(l) } s && ((n = this._find(i)) ? n.tooltip.find(".ui-tooltip-content").html(s) : (i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")), n = this._tooltip(i), o = n.tooltip, this._addDescribedBy(i, o.attr("id")), o.find(".ui-tooltip-content").html(s), this.liveRegion.children().hide(), (r = t("<div>").html(o.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), r.removeAttr("id").find("[id]").removeAttr("id"), r.appendTo(this.liveRegion), this.options.track && e && /^mouse/.test(e.type) ? (this._on(this.document, { mousemove: h }), h(e)) : o.position(t.extend({ of: i }, this.options.position)), o.hide(), this._show(o, this.options.show), this.options.track && this.options.show && this.options.show.delay && (a = this.delayedShow = setInterval((function () { o.is(":visible") && (h(l.of), clearInterval(a)) }), t.fx.interval)), this._trigger("open", e, { tooltip: o }))) }, _registerCloseHandlers: function (e, i) { var s = { keyup: function (e) { if (e.keyCode === t.ui.keyCode.ESCAPE) { var s = t.Event(e); s.currentTarget = i[0], this.close(s, !0) } } }; i[0] !== this.element[0] && (s.remove = function () { this._removeTooltip(this._find(i).tooltip) }), e && "mouseover" !== e.type || (s.mouseleave = "close"), e && "focusin" !== e.type || (s.focusout = "close"), this._on(!0, i, s) }, close: function (e) { var i, s = this, n = t(e ? e.currentTarget : this.element), o = this._find(n); o ? (i = o.tooltip, o.closing || (clearInterval(this.delayedShow), n.data("ui-tooltip-title") && !n.attr("title") && n.attr("title", n.data("ui-tooltip-title")), this._removeDescribedBy(n), o.hiding = !0, i.stop(!0), this._hide(i, this.options.hide, (function () { s._removeTooltip(t(this)) })), n.removeData("ui-tooltip-open"), this._off(n, "mouseleave focusout keyup"), n[0] !== this.element[0] && this._off(n, "remove"), this._off(this.document, "mousemove"), e && "mouseleave" === e.type && t.each(this.parents, (function (e, i) { t(i.element).attr("title", i.title), delete s.parents[e] })), o.closing = !0, this._trigger("close", e, { tooltip: i }), o.hiding || (o.closing = !1))) : n.removeData("ui-tooltip-open") }, _tooltip: function (e) { var i = t("<div>").attr("role", "tooltip"), s = t("<div>").appendTo(i), n = i.uniqueId().attr("id"); return this._addClass(s, "ui-tooltip-content"), this._addClass(i, "ui-tooltip", "ui-widget ui-widget-content"), i.appendTo(this._appendTo(e)), this.tooltips[n] = { element: e, tooltip: i } }, _find: function (t) { var e = t.data("ui-tooltip-id"); return e ? this.tooltips[e] : null }, _removeTooltip: function (t) { t.remove(), delete this.tooltips[t.attr("id")] }, _appendTo: function (t) { var e = t.closest(".ui-front, dialog"); return e.length || (e = this.document[0].body), e }, _destroy: function () { var e = this; t.each(this.tooltips, (function (i, s) { var n = t.Event("blur"), o = s.element; n.target = n.currentTarget = o[0], e.close(n, !0), t("#" + i).remove(), o.data("ui-tooltip-title") && (o.attr("title") || o.attr("title", o.data("ui-tooltip-title")), o.removeData("ui-tooltip-title")) })), this.liveRegion.remove() } }), !1 !== t.uiBackCompat && t.widget("ui.tooltip", t.ui.tooltip, { options: { tooltipClass: null }, _tooltip: function () { var t = this._superApply(arguments); return this.options.tooltipClass && t.tooltip.addClass(this.options.tooltipClass), t } }); t.ui.tooltip
    })), function (t) { t("#pricipal-slide").slider({ range: "min", min: 500, max: 7500, value: 1500, step: 1e3, slide: function (e, i) { t("#pricipal").text(i.value), loancalculate() } }), t("#pricipal").text(t("#pricipal-slide").slider("value")), t("#totalyear-slide").slider({ range: "min", min: 12, max: 360, step: 1, value: 120, slide: function (e, i) { t("#totalyear").text(i.value), loancalculate() } }), t("#totalyear").text(t("#totalyear-slide").slider("value")), t("#intrest-slide").slider({ range: "min", min: 6.1, max: 16.2, step: .01, value: 10, slide: function (e, i) { t("#intrest").text(i.value), loancalculate() } }), t("#intrest").text(t("#intrest-slide").slider("value")), loancalculate() }(jQuery); var __slice = [].slice, __indexOf = [].indexOf || function (t) { for (var e = 0, i = this.length; e < i; e++)if (e in this && this[e] === t) return e; return -1 }; function eligiable() { var t = document.formval2.pr_amt2.value, e = document.formval2.int_rate2.value, i = document.formval2.period2.value, s = e / 1200, n = t * s * Math.pow(1 + s, 12 * i) / (Math.pow(1 + s, 12 * i) - 1), o = Math.ceil(100 * n) / 100, a = document.formval2.ExLoan.value, r = a - 60 * a / 100, l = document.formval2.NetIncome.value; if (l <= 14999) var h = 40 * l / 100 - r; else if (l <= 29999) h = 45 * l / 100 - r; else if (l >= 3e4) h = 50 * l / 100 - r; var c = Math.floor(h / o * t), u = c * s * Math.pow(1 + s, 12 * i) / (Math.pow(1 + s, 12 * i) - 1), d = Math.ceil(100 * u) / 100; c > t ? (document.formval3.field13.value = "You are Eligible for this loan", document.formval3.field11.value = "₹ " + t + " at EMI ₹ " + o.toFixed(0), document.formval3.field12.value = "You are Eligible for a maximum loan of ₹ " + c + " at EMI ₹ " + d.toFixed(0)) : (document.formval3.field13.value = "You are not Eligible for this loan", document.formval3.field11.value = "", document.formval3.field12.value = "You are Eligible for a maximum loan of ₹ " + c + " at EMI ₹ " + d.toFixed(0)) } !function (t, e) { var i; i = function () { function e(e, i) { var s, n = this; this.input = e, this.defaultOptions = { animate: !0, snapMid: !1, classPrefix: null, classSuffix: null, theme: null, highlight: !1 }, this.settings = t.extend({}, this.defaultOptions, i), this.settings.theme && (this.settings.classSuffix = "-" + this.settings.theme), this.input.hide(), this.slider = t("<div>").addClass("slider" + (this.settings.classSuffix || "")).css({ position: "relative", userSelect: "none", boxSizing: "border-box" }).insertBefore(this.input), this.input.attr("id") && this.slider.attr("id", this.input.attr("id") + "-slider"), this.track = this.createDivElement("track").css({ width: "100%" }), this.settings.highlight && (this.highlightTrack = this.createDivElement("highlight-track").css({ width: "0" })), this.dragger = this.createDivElement("dragger"), this.slider.css({ minHeight: this.dragger.outerHeight(), marginLeft: this.dragger.outerWidth() / 0, marginRight: this.dragger.outerWidth() / 0 }), this.track.css({ marginTop: this.track.outerHeight() / -2 }), this.settings.highlight && this.highlightTrack.css({ marginTop: this.track.outerHeight() / -2 }), this.dragger.css({ marginTop: this.dragger.outerHeight() / -2, marginLeft: this.dragger.outerWidth() / -2 }), this.track.mousedown((function (t) { return n.trackEvent(t) })), this.settings.highlight && this.highlightTrack.mousedown((function (t) { return n.trackEvent(t) })), this.dragger.mousedown((function (t) { if (1 === t.which) return n.dragging = !0, n.dragger.addClass("dragging"), n.domDrag(t.pageX, t.pageY), !1 })), t("body").mousemove((function (e) { if (n.dragging) return n.domDrag(e.pageX, e.pageY), t("body").css({ cursor: "pointer" }) })).mouseup((function (e) { if (n.dragging) return n.dragging = !1, n.dragger.removeClass("dragging"), t("body").css({ cursor: "auto" }) })), this.pagePos = 0, "" === this.input.val() ? (this.value = this.getRange().min, this.input.val(this.value)) : this.value = this.nearestValidValue(this.input.val()), this.setSliderPositionFromValue(this.value), s = this.valueToRatio(this.value), this.input.trigger("slider:ready", { value: this.value, ratio: s, position: s * this.slider.outerWidth(), el: this.slider }) } return e.prototype.createDivElement = function (e) { return t("<div>").addClass(e).css({ position: "absolute", top: "50%", userSelect: "none", cursor: "pointer" }).appendTo(this.slider) }, e.prototype.setRatio = function (t) { var e; return t = Math.min(1, t), t = Math.max(0, t), e = this.ratioToValue(t), this.setSliderPositionFromValue(e), this.valueChanged(e, t, "setRatio") }, e.prototype.setValue = function (t) { var e; return t = this.nearestValidValue(t), e = this.valueToRatio(t), this.setSliderPositionFromValue(t), this.valueChanged(t, e, "setValue") }, e.prototype.trackEvent = function (t) { if (1 === t.which) return this.domDrag(t.pageX, t.pageY, !0), this.dragging = !0, !1 }, e.prototype.domDrag = function (t, e, i) { var s, n, o; if (null == i && (i = !1), s = t - this.slider.offset().left, s = Math.min(this.slider.outerWidth(), s), s = Math.max(0, s), this.pagePos !== s) return this.pagePos = s, n = s / this.slider.outerWidth(), o = this.ratioToValue(n), this.valueChanged(o, n, "domDrag"), this.settings.snap ? this.setSliderPositionFromValue(o, i) : this.setSliderPosition(s, i) }, e.prototype.setSliderPosition = function (t, e) { if (null == e && (e = !1), e && this.settings.animate) { if (this.dragger.animate({ left: t }, 200), this.settings.highlight) return this.highlightTrack.animate({ width: t }, 200) } else if (this.dragger.css({ left: t }), this.settings.highlight) return this.highlightTrack.css({ width: t }) }, e.prototype.setSliderPositionFromValue = function (t, e) { var i; return null == e && (e = !1), i = this.valueToRatio(t), this.setSliderPosition(i * this.slider.outerWidth(), e) }, e.prototype.getRange = function () { return this.settings.allowedValues ? { min: Math.min.apply(Math, this.settings.allowedValues), max: Math.max.apply(Math, this.settings.allowedValues) } : this.settings.range ? { min: parseFloat(this.settings.range[0]), max: parseFloat(this.settings.range[1]) } : { min: 0, max: 1 } }, e.prototype.nearestValidValue = function (e) { var i, s, n, o; return n = this.getRange(), e = Math.min(n.max, e), e = Math.max(n.min, e), this.settings.allowedValues ? (i = null, t.each(this.settings.allowedValues, (function () { if (null === i || Math.abs(this - e) < Math.abs(i - e)) return i = this })), i) : this.settings.step ? (s = (n.max - n.min) / this.settings.step, o = Math.floor((e - n.min) / this.settings.step), (e - n.min) % this.settings.step > this.settings.step / 2 && o < s && (o += 1), o * this.settings.step + n.min) : e }, e.prototype.valueToRatio = function (t) { var e, i, s, n, o, a, r, l; if (this.settings.equalSteps) { for (n = a = 0, r = (l = this.settings.allowedValues).length; a < r; n = ++a)e = l[n], (null == i || Math.abs(e - t) < Math.abs(i - t)) && (i = e, s = n); return this.settings.snapMid ? (s + .5) / this.settings.allowedValues.length : s / (this.settings.allowedValues.length - 1) } return (t - (o = this.getRange()).min) / (o.max - o.min) }, e.prototype.ratioToValue = function (t) { var e, i, s, n, o; return this.settings.equalSteps ? (o = this.settings.allowedValues.length, n = Math.round(t * o - .5), e = Math.min(n, this.settings.allowedValues.length - 1), this.settings.allowedValues[e]) : (s = t * ((i = this.getRange()).max - i.min) + i.min, this.nearestValidValue(s)) }, e.prototype.valueChanged = function (e, i, s) { var n; if (e.toString() !== this.value.toString()) return this.value = e, n = { value: e, ratio: i, position: i * this.slider.outerWidth(), trigger: s, el: this.slider }, this.input.val(e).trigger(t.Event("change", n)).trigger("slider:changed", n) }, e }(), t.extend(t.fn, { simpleSlider: function () { var e, s, n; return n = arguments[0], e = 2 <= arguments.length ? __slice.call(arguments, 1) : [], s = ["setRatio", "setValue"], t(this).each((function () { var o, a; return n && __indexOf.call(s, n) >= 0 ? (o = t(this).data("slider-object"))[n].apply(o, e) : (a = n, t(this).data("slider-object", new i(t(this), a))) })) } }), t((function () { return t("[data-slider]").each((function () { var e, i, s, n; return e = t(this), s = {}, (i = e.data("slider-values")) && (s.allowedValues = function () { var t, e, s, o; for (o = [], t = 0, e = (s = i.split(",")).length; t < e; t++)n = s[t], o.push(parseFloat(n)); return o }()), e.data("slider-range") && (s.range = e.data("slider-range").split(",")), e.data("slider-step") && (s.step = e.data("slider-step")), s.snap = e.data("slider-snap"), s.equalSteps = e.data("slider-equal-steps"), e.data("slider-theme") && (s.theme = e.data("slider-theme")), e.attr("data-slider-highlight") && (s.highlight = e.data("slider-highlight")), null != e.data("slider-animate") && (s.animate = e.data("slider-animate")), e.simpleSlider(s) })) })) }(this.jQuery || this.Zepto), function () { if ($("#loantable").length) { function t() { var t = $("#la_value").html(), e = $("#nm_value").html(), i = $("#roi_value").html(), s = i / 100 / 12, n = Math.pow(1 + s, e), o = t * s * (n / (n - 1)), a = e * o, r = a - t, l = r / a * 100; $("#tbl_int_pge").html(l.toFixed(2) + " %"); var h = o.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), c = t.toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), u = a.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","), d = r.toFixed(2).toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ","); $("#emi").html(h), $("#tbl_emi").html(h), $("#tbl_la").html(c), $("#tbl_nm").html(e), $("#tbl_roi").html(i), $("#tbl_full").html(u), $("#tbl_int").html(d); for (var p = "<thead ><tr class='table-head'><th>Payment No.</th><th>Begining Balance</th><th>EMI</th><th>Principal</th><th>Interest</th><th>Ending Balance</th></thead><tbody>", f = parseInt(t), g = 0, m = 0, _ = 0, v = 1; v <= e; v++)g = f * (i / 100 / 12), _ = f - (m = o.toFixed(2) - g.toFixed(2)).toFixed(2), p += "<tr><td>" + v + "</td><td>" + f.toFixed(2) + "</td><td>" + o.toFixed(2) + "</td><td>" + m.toFixed(2) + "</td><td>" + g.toFixed(2) + "</td><td>" + _.toFixed(2) + "</td></tr>", f -= m.toFixed(2); p += "</tbody>", $("#loantable").html(p) } $("#la").bind("slider:changed", (function (e, i) { $("#la_value").html(i.value.toFixed(0)), t() })), $("#nm").bind("slider:changed", (function (e, i) { $("#nm_value").html(i.value.toFixed(0)), t() })), $("#roi").bind("slider:changed", (function (e, i) { $("#roi_value").html(i.value.toFixed(2)), t() })), t() } }(), function () { var t = $("[data-isotope]"); $("[data-filter]").on("click", (function () { var t = $(this), e = t.data("filter"), i = t.data("target"); $(i).isotope({ filter: e }) })), t.imagesLoaded().progress((function () { t.isotope("layout") })) }(), $(".image-link").magnificPopup({ type: "image", mainClass: "mfp-with-zoom", zoom: { enabled: !0, duration: 300, easing: "ease-in-out", opener: function (t) { return t.is("img") ? t : t.find("img") } }, image: { titleSrc: "title" }, gallery: { enabled: !0 } }), function () { for (var t = document.getElementsByTagName("pre"), e = 0; e < t.length; e++) { if (0 === t[e].children[0].className.indexOf("language-")) { var i = document.createElement("button"); i.className = "copy-button", i.textContent = "Copy", t[e].appendChild(i) } } var s = new Clipboard(".copy-button", { target: function (t) { return t.previousElementSibling } }); s.on("success", (function (t) { t.clearSelection(), t.trigger.textContent = "Copied", window.setTimeout((function () { t.trigger.textContent = "Copy" }), 2e3) })), s.on("error", (function (t) { t.trigger.textContent = 'Press "Ctrl + C" to copy', window.setTimeout((function () { t.trigger.textContent = "Copy" }), 5e3) })) }();